...
const productSubCategoryRoutes = require("./routes/inventory/productSubCategory/productSubCategory.routes");
const productBrandRoutes = require("./routes/inventory/productBrand/productBrand.routes");
const {
  productRoutes,
  productImageRoutes,
...
"https://pososf.netlify.app",
  "http://localhost:3001",
  "https://pos-os-frontend-ktip0msz5-hritik-4642d12e.vercel.app"
